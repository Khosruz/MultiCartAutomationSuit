...
public class TestBase {
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream fis = new FileInputStream("/Users/khosuzzaman/Selenium_Stuff"
					+ "/MultiCartOnline/src/main/java/com/mco/configuration/config.properties");
			prop.load(fis);
	...
	public static void initialization() {
		...
		if (browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver","/Users/khosuzzaman/chromedriver");
			driver = new ChromeDriver();
		} else if (browserName.equals("ff")) {
			System.setProperty("webdriver.gecko.driver","/Users/khosuzzaman/geckodriver");
